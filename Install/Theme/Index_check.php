<div class="am-form-group">
    ...
    <div class="am-u-sm-10">
        ...
        <?php if ($version == false): ?>
            <a href="http://php.net/downloads.php" class="install_tips" target="_blank"><i class="am-icon-frown-o"></i> PESCMS TEAM必须运行于PHP5.4或更高级的版本，请升级版本</a>
        <?php endif; ?>
    </div>
</div>
...
<div class="am-form-group">
    ...
    <div class="am-u-sm-10">
        ...
        <?php if ($pdo == false): ?>
            <a href="http://php.net/manual/zh/book.pdo.php" class="install_tips" target="_blank"><i class="am-icon-frown-o"></i> PESCMS TEAM依靠pdo_mysql进行链接数据库，否则程序无法安装!</a>
        <?php endif; ?>
    </div>
</div>
