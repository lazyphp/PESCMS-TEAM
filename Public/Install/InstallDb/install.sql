...
INSERT INTO `pes_option` VALUES (-1,'setting_sort','设置排序','{\"上传设置\":2,\"网站信息\":1,\"通知设置\":\"4\"}','sort','设置排序','array','text','',0,'',0),(13,'version','系统版本','','system','网站信息','setting_version','setting_version','',0,'',0),(14,'upload_img','图片格式','[\".jpg\",\".jpge\",\".bmp\",\".gif\",\".png\"]','upload','上传设置','json','text','',1,'',0),(15,'upload_file','文件格式','[\".zip\",\".rar\",\".7z\",\".doc\",\".docx\",\".pdf\",\".xls\",\".xlsx\",\".ppt\",\".pptx\",\".txt\"]','upload','上传设置','json','text','',1,'',0),(17,'mail','电子邮箱账号设置','{\"account\":\"\",\"passwd\":\"\",\"address\":\"\",\"port\":\"\"}','email','通知设置','setting_option','setting_option','{\"account\":\"邮箱账户\",\"passwd\":\"邮箱密码\",\"address\":\"SMTP地址\",\"port\":\"邮箱端口\"}',0,'',1),(22,'notice_way','消息推送方式','2','system','通知设置','string','radio','{\"被动触发\":\"1\",\"定时触发\":\"2\",\"两者兼有\":\"3\"}',1,'',0),(23,'max_upload_size','上传大小(M)','10','upload','上传设置','string','text','',1,'',0),(24,'mail_test','邮件发送测试','','email','通知设置','send_test','send_test','/?g=Team&m=Setting&a=emailTest',0,'',2),(25,'siteTitle','网站标题','PESCMS Team','system','网站信息','string','text','',1,'',2),(26,'domain','网站域名','','system','网站信息','string','text','',1,'',1);
...
-- Dump completed on 2022-12-01 22:54:54
