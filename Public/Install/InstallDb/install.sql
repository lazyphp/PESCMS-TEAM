...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='权限节点' AUTO_INCREMENT=108 ;
...
(14, 'upload_img', '图片格式', '[".jpg",".jpge",".bmp",".gif",".png"]', 'system'),
(15, 'upload_file', '文件格式', '[".zip",".rar",".7z",".doc",".docx",".pdf",".xls",".xlsx",".ppt",".pptx",".txt"]', 'system'),
