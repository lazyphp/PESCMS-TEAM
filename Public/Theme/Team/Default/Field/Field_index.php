...
<script>
    $(function(){
        $("input[name=keyword]").after('<input type="hidden" name="model_id" value="<?=(int) $_GET['model_id'] ?? null?>"/><input type="hidden" name="back_url" value="<?=$label->xss($_GET['back_url'] ?? null)?>"/>')
    })
</script>
