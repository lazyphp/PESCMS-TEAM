    ...
    <div class="am-u-sm-12 am-u-md-12">
        <form class="am-form-inline">
            ...
            <div class="am-form-group">
                <input type="text" name="begin" value="<?= $_GET['begin'] ?>" class="am-form-field" placeholder="开始日期" data-am-datepicker readonly>
            </div>

            <div class="am-form-group">
                <input type="text" name="end" value="<?= $_GET['end'] ?>" class="am-form-field" placeholder="结束日期" data-am-datepicker readonly>
            </div>
