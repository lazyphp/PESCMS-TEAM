...
<html class="no-js">
    <head>
        ...
        <link rel="icon" type="image/png" href="/Theme/Team/WorkHard/assets/i/favicon.png">
        <link rel="apple-touch-icon-precomposed" href="/Theme/Team/WorkHard/assets/i/app-icon72x72@2x.png">
